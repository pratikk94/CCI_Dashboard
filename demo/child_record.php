...
<div class="container-fluid page-body-wrapper">
    ...
    <div class
    "col-md-6 grid-margin stretch-card" style="width:50%;padding-bottom: 10px;border-block-end: 1px blue dotted;">
    Is the child using a tablet ? : <?php
    echo $tab = ($row ['has_tablet'] == '1') ? "Yes" : "No";
    ?>
</div>
<div class
    "col-md-6 grid-margin stretch-card" style="width:50%;padding-bottom: 10px;border-block-end: 1px blue dotted;">
...
<div class
    "col-md-6 grid-margin stretch-card" style="width:50%;padding-bottom: 10px;border-block-end: 1px blue dotted;">
    Child has Birth Certificate: <?php
echo $row ['birth_certificate'];
?>
    </div>
<div class
    "col-md-6 grid-margin stretch-card" style="width:50%;padding-bottom: 10px;border-block-end: 1px blue dotted;">
    Date of Admission in CCI: <?php
...
<div class="card">
    <div class="card-body">
        ...
        <!-- partial:partials/_footer.html 
		 ...
		 <td><?php echo $row['aq2']; ?></td>
                            <td><?php echo $row['aq3']; ?></td>-->
            ...
            <div class="col-12">
                <div class="table-responsive">
                    <table id="order-listing" class="table">
                        ...
                        <tbody>
                        <?php
                        $sql = "select * from tbl_child_week where cciid=$cciid and cid=$cid order by cwid DESC";
