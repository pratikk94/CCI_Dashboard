    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">District Login</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    ...
                    <form action="district_login_action.php" method="POST" class="signin-form">
...
<input type="radio" id="type" name="type" value="district">
<label for="district">Login for district wise view</label>
                            </div>
